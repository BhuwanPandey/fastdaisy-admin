...
And also, you can provide file path which contain `Admin` instance as 
...
``` python {5,22-24,41-42}

import contextlib
from sqlalchemy import Column, Boolean, Integer, String, Text, create_engine
...
To log out, click the Logout button located in the navigation bar. This will clear the session data from your cookies.
You will also see an Edit Profile button in the navigation bar when you register a user admin as shown below:
